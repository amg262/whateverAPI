    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Welcome to JokeAPI</h1>
          <p className="text-gray-600">Sign in to discover and share amazing jokes</p>
        </div>
        ...
        {!isManualLogin ? (
          <div className="space-y-4">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-200 rounded-lg px-6 py-3 text-gray-700 font-medium hover:bg-gray-50 hover:border-gray-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24">
                ...
                <path fill="#00a1f1" d="M12.623 0H24v11.372H12.623z"/>
          ...
          <form onSubmit={handleManualLogin} className="space-y-4">
            ...
            <button
              ...
              className="w-full text-center text-gray-600 hover:text-gray-800 font-medium transition-colors"
            >
